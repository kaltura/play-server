...
KalturaUrlTokenMapper = {
	...
	mapTokens: function(sourceUrl, cuePointId, entry, entryMetadata, playerConfig, originalRequest, callback){
		var res = sourceUrl;
		...
		var buildEvaluationData = function(type){
			...
			else
			{
				...
				if(originalRequest != null){
					data.mediaSession = {};
					data.mediaSession.userIPaddress = originalRequest.ip;
					data.mediaSession.userAgent = originalRequest.headers['user-agent'];					
				}
			}
		};
	},
