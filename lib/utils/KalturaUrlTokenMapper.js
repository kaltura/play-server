...
KalturaUrlTokenMapper = {
	...
	mapFixedTokensVod: function(request, cuePointId, cuePointUrl, partnerId, entryId, callback) {
		this.getEntryAndMetadata(partnerId, entryId, null, function(entryObj, metadataObj){
			this.doMapFixedTokens(request, cuePointId, cuePointUrl, entryObj, metadataObj, null, callback);
		});
	},
