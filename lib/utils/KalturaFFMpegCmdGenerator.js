...
class KalturaFFMpegCmdGenerator
{
	 ...
	 * @returns {*}
	 */
	static generateCommandLineFormat(flavorId, MediaInfoJson, apiConnector, impersonateId = null)
	{
		return apiConnector.handleRequset('flavorAsset', 'serveAdStitchCmd', [flavorId, MediaInfoJson], impersonateId);
	}
