...
class KalturaFFMpegCmdGenerator
{
	 ...
	 * @returns {*}
	 */
	static generateCommandLineFormat(flavorId, MediaInfoJson, durationInSeconds, apiConnector, impersonateId = null)
	{
		return apiConnector.handleApiRequest('flavorAsset', 'serveAdStitchCmd', [flavorId, MediaInfoJson, durationInSeconds], impersonateId);
	}
