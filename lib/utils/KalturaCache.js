...
//		});
	...
	getMediaInfo : function(renditionId) {
		return 'mediaInfo-' + renditionId;
	},
	...
	getSessionServerAdId : function(cuePointId, renditionId, sessionId) {
	...
	buildEntryRequiredValue: function(entryRequired, renditionUrl){
		return entryRequired + '\n' + KalturaCache.getManifestId(renditionUrl);
	},
	...
	extractSessionServerAdIdValue: function(sessionServerAdId){
		var sessionServerAdId = sessionServerAdId.split('\n');
		var serverAdIds = [];
