...
//		});
	...
	getPostSegmentStitchedId: function(cuePointId, serverAdIds, segmentIndex){
		var lastServerAdId = serverAdIds[serverAdIds.length-1];
		var adId = lastServerAdId.id.split('-')[0];
		return (cuePointId + '-' + segmentIndex + '-' + adId + '-' + lastServerAdId.startPos + '-' + lastServerAdId.endPos).md5();
	},
