...
/* global KalturaLogger, KalturaConfig */
/**
...
{
	constructor(pathToMediaInfoExecutor)
	{
		if (!pathToMediaInfoExecutor)
		{
			if (KalturaConfig.config.bin.ffprobePath)
				this._pathToMediaInfoExecutor = KalturaConfig.config.bin.ffprobePath;
			else
				this._pathToMediaInfoExecutor = 'ffprobe';
		}
		else
