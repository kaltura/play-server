...
KalturaLogger = {
	...
	init: function(){
		...
		if(KalturaLogger.config.debugEnabled){
			KalturaLogger.debugEnabled = KalturaLogger.config.debugEnabled;
		}
		...
		if(KalturaLogger.config.accessLogPath){
			KalturaLogger.accessLogFile = fs.openSync(KalturaLogger.config.accessLogPath, 'a');		
		}
		
		if(KalturaLogger.config.logPath){
			KalturaLogger.logFile = fs.openSync(KalturaLogger.config.logPath, 'a');
		}
		
		if(KalturaLogger.config.errorPath){
			KalturaLogger.errorFile = fs.openSync(KalturaLogger.config.errorPath, 'a');			
		}
	},
