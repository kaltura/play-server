...
class VastSizeFilter
{
	...
	static _chooseBetterFile(originalFlavorAttributes, currentAdAttributes, bestAdAttributesSoFar)
	{
		const bestSoFarScore = new AdCreativeAnalyzer(originalFlavorAttributes, bestAdAttributesSoFar).calculatedScore;
		const currentScore = new AdCreativeAnalyzer(originalFlavorAttributes, currentAdAttributes).calculatedScore;
		if (currentScore > bestSoFarScore)
			return currentAdAttributes;
		return bestAdAttributesSoFar;
	}
