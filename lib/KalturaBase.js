...
KalturaCache.prototype = {
	...
	getEncodingParams : function(encodingParamsId) {
		return 'encodingParams-' + encodingParamsId;
	},

	getBlackEncodingParams : function(encodingParamsId) {
		return 'blackEncodingParams-' + encodingParamsId;
	},
