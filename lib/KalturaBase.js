...
KalturaBase.prototype = {
	...
	callPlayServerService : function(service, action, partnerId, params, successCallback, failureCallback){
		...
		var playServerUrl = this.getPlayServerUrl(service, action, partnerId, signedParams, null, KalturaConfig.config.cloud.internalDomain);
