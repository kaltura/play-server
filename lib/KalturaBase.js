...
KalturaCache.prototype = {
	...
	getServerAdId : function(entryId, cuePointId, sourceUrl, renditionId) {
		return (entryId + '-' + cuePointId + '-' + sourceUrl + '-' + renditionId).md5();
	},

	getPlayerAdId : function(entryId, cuePointId) {
		return ('player-' + entryId + '-' + cuePointId).md5();
	},

	getPreSegmentId : function(entryId, renditionId) {
		return ('pre-' + entryId + '-' + renditionId).md5();
	},

	getPostSegmentId : function(entryId, renditionId) {
		return ('post-' + entryId + '-' + renditionId).md5();
	},
