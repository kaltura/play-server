...
KalturaCache.prototype = {
	...
	getPlayerAdId : function(entryId, cuePointId, renditionId) {
		return ('ad-' + entryId + '-' + cuePointId + '-' + renditionId).md5();
	},

	getPreSegmentId : function(entryId, cuePointId, renditionId) {
		return ('pre-' + entryId + '-' + cuePointId + '-' + renditionId).md5();
	},

	getPostSegmentId : function(entryId, cuePointId, renditionId) {
		return ('post-' + entryId + '-' + cuePointId + '-' + renditionId).md5();
	},
