...
/**
 *Class definition for the Kaltura service: batchcontrol.
 * The available service actions:
 * @action reportStatus batch reportStatus action saves the a status attribute from a remote scheduler and returns pending commands for the scheduler.
 * @action configLoaded batch configLoaded action saves the configuration as loaded by a remote scheduler.
 * @action stopScheduler batch stop action stops a scheduler.
 * @action stopWorker batch stop action stops a worker.
 * @action kill batch kill action forces stop og a batch on a remote scheduler.
 * @action startWorker batch start action starts a job.
 * @action setSchedulerConfig batch sets a configuration parameter to be loaded by a scheduler.
 * @action setWorkerConfig batch sets a configuration parameter to be loaded by a worker.
 * @action setCommandResult batch setCommandResult action saves the results of a command as recieved from a remote scheduler.
 * @action listCommands list batch control commands.
 * @action getCommand batch getCommand action returns the command with its current status.
 * @action listSchedulers list all Schedulers.
 * @action listWorkers list all Workers.
 * @action getFullStatus batch getFullStatus action returns the status of all schedulers and queues.
 */
function KalturaBatchcontrolService(client){
	KalturaBatchcontrolService.super_.call(this);
	this.init(client);
}

util.inherits(KalturaBatchcontrolService, kaltura.KalturaServiceBase);
module.exports.KalturaBatchcontrolService = KalturaBatchcontrolService;
 ...
 * @param scheduler KalturaScheduler The scheduler (optional).
 * @param schedulerStatuses array A scheduler status array (optional).
 * @param workerQueueFilters array Filters list to get queues (optional).
 * @return KalturaSchedulerStatusResponse.
 */
KalturaBatchcontrolService.prototype.reportStatus = function(callback, scheduler, schedulerStatuses, workerQueueFilters){
	var kparams = {};
	this.client.addParam(kparams, 'scheduler', kaltura.toParams(scheduler));
for(var index in schedulerStatuses)
{
	var obj = schedulerStatuses[index];
	this.client.addParam(kparams, 'schedulerStatuses:' + index, kaltura.toParams(obj));
}
for(var index in workerQueueFilters)
{
	var obj = workerQueueFilters[index];
	this.client.addParam(kparams, 'workerQueueFilters:' + index, kaltura.toParams(obj));
}
 ...
 * @param scheduler KalturaScheduler The remote scheduler (optional).
 * @param configParam string The parameter that was loaded (optional).
 * @param configValue string The value that was loaded (optional).
 * @param configParamPart string The parameter part that was loaded (optional, default: null).
 * @param workerConfigId int The id of the job that the configuration refers to, not mandatory if the configuration refers to the scheduler (optional, default: null).
 * @param workerName string The name of the job that the configuration refers to, not mandatory if the configuration refers to the scheduler (optional, default: null).
 * @return KalturaSchedulerConfig.
 */
KalturaBatchcontrolService.prototype.configLoaded = function(callback, scheduler, configParam, configValue, configParamPart, workerConfigId, workerName){
	if(!configParamPart){
 ...
 * @param schedulerId int The id of the remote scheduler location (optional).
 * @param adminId int The id of the admin that called the stop (optional).
 * @param cause string The reason it was stopped (optional).
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.stopScheduler = function(callback, schedulerId, adminId, cause){
	var kparams = {};
 ...
 * @param workerId int The id of the job to be stopped (optional).
 * @param adminId int The id of the admin that called the stop (optional).
 * @param cause string The reason it was stopped (optional).
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.stopWorker = function(callback, workerId, adminId, cause){
	var kparams = {};
 ...
 * @param workerId int The id of the job to be stopped (optional).
 * @param batchIndex int The index of the batch job process to be stopped (optional).
 * @param adminId int The id of the admin that called the stop (optional).
 * @param cause string The reason it was stopped (optional).
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.kill = function(callback, workerId, batchIndex, adminId, cause){
	var kparams = {};
	this.client.addParam(kparams, 'workerId', workerId);
 ...
 * @param workerId int The id of the job to be started (optional).
 * @param adminId int The id of the admin that called the start (optional).
 * @param cause string The reason it was started (optional, default: null).
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.startWorker = function(callback, workerId, adminId, cause){
	if(!cause){
		cause = null;
	}
	var kparams = {};
 ...
 * @param schedulerId int The id of the remote scheduler location (optional).
 * @param adminId int The id of the admin that called the setConfig (optional).
 * @param configParam string The parameter to be set (optional).
 * @param configValue string The value to be set (optional).
 * @param configParamPart string The parameter part to be set - for additional params (optional, default: null).
 * @param cause string The reason it was changed (optional, default: null).
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.setSchedulerConfig = function(callback, schedulerId, adminId, configParam, configValue, configParamPart, cause){
	if(!configParamPart){
		configParamPart = null;
	}
	if(!cause){
 ...
 * @param workerId int The id of the job to be configured (optional).
 * @param adminId int The id of the admin that called the setConfig (optional).
 * @param configParam string The parameter to be set (optional).
 * @param configValue string The value to be set (optional).
 * @param configParamPart string The parameter part to be set - for additional params (optional, default: null).
 ...
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.setWorkerConfig = function(callback, workerId, adminId, configParam, configValue, configParamPart, cause){
	if(!configParamPart){
		configParamPart = null;
	}
	if(!cause){
 ...
 * @param commandId int The id of the command (optional).
 * @param status int The status of the command (optional, enum: KalturaControlPanelCommandStatus).
 * @param errorDescription string The description, important for failed commands (optional, default: null).
 * @return KalturaControlPanelCommand.
 */
KalturaBatchcontrolService.prototype.setCommandResult = function(callback, commandId, status, errorDescription){
	if(!errorDescription){
 ...
 * @param filter KalturaControlPanelCommandFilter  (optional, default: null).
 * @param pager KalturaFilterPager  (optional, default: null).
 * @return KalturaControlPanelCommandListResponse.
 */
KalturaBatchcontrolService.prototype.listCommands = function(callback, filter, pager){
	if(!filter){
		filter = null;
	}
	if(!pager){
 ...
 */
KalturaBatchcontrolService.prototype.listSchedulers = function(callback){
	var kparams = {};
 ...
 */
KalturaBatchcontrolService.prototype.listWorkers = function(callback){
	var kparams = {};
 ...
 */
KalturaBatchcontrolService.prototype.getFullStatus = function(callback){
	var kparams = {};
...
/**
 *Class definition for the Kaltura service: batch.
 * The available service actions:
 ...
 * @action countBulkUploadEntries Returns total created entries count and total error entries count.
 ...
 * @action updatePartnerLoadTable batch updatePartnerLoadTable action cleans the partner load table.
 * @action suspendJobs batch suspendJobs action suspends jobs from running.
 ...
 * @action checkEntryIsDone batch checkEntryIsDone Check weather a specified entry is done converting and changes it to ready.
 */
function KalturaBatchService(client){
	KalturaBatchService.super_.call(this);
	this.init(client);
}

util.inherits(KalturaBatchService, kaltura.KalturaServiceBase);
module.exports.KalturaBatchService = KalturaBatchService;

/**
 * batch addBulkUploadResultAction action adds KalturaBulkUploadResult to the DB.
 * @param bulkUploadResult KalturaBulkUploadResult The results to save to the DB (optional).
 * @param pluginDataArray array  (optional, default: null).
 * @return KalturaBulkUploadResult.
 */
KalturaBatchService.prototype.addBulkUploadResult = function(callback, bulkUploadResult, pluginDataArray){
	if(!pluginDataArray){
		pluginDataArray = null;
	}
	var kparams = {};
	this.client.addParam(kparams, 'bulkUploadResult', kaltura.toParams(bulkUploadResult));
	if(pluginDataArray !== null){
	for(var index in pluginDataArray)
	{
		var obj = pluginDataArray[index];
		this.client.addParam(kparams, 'pluginDataArray:' + index, kaltura.toParams(obj));
	}
	}
 ...
 * @param bulkUploadJobId int The id of the bulk upload job (optional).
 * @return KalturaBulkUploadResult.
 */
KalturaBatchService.prototype.getBulkUploadLastResult = function(callback, bulkUploadJobId){
	var kparams = {};
 ...
 * @param bulkUploadJobId int The id of the bulk upload job (optional).
 * @param bulkUploadObjectType string  (optional, enum: KalturaBulkUploadObjectType, default: null).
 * @return array.
 */
KalturaBatchService.prototype.countBulkUploadEntries = function(callback, bulkUploadJobId, bulkUploadObjectType){
	if(!bulkUploadObjectType){
		bulkUploadObjectType = null;
	}
	var kparams = {};
	this.client.addParam(kparams, 'bulkUploadJobId', bulkUploadJobId);
 ...
 * @return int.
 */
KalturaBatchService.prototype.updateBulkUploadResults = function(callback, bulkUploadJobId){
	var kparams = {};
	this.client.addParam(kparams, 'bulkUploadJobId', bulkUploadJobId);
 ...
 * @param id int The id of the job to free (optional).
 ...
 * @param flavorsData array  (optional, default: null).
 * @return KalturaBatchJob.
 */
KalturaBatchService.prototype.updateExclusiveConvertCollectionJob = function(callback, id, lockKey, job, flavorsData){
	if(!flavorsData){
		flavorsData = null;
	}
	var kparams = {};
	...
	this.client.addParam(kparams, 'job', kaltura.toParams(job));
	if(flavorsData !== null){
	for(var index in flavorsData)
	{
		var obj = flavorsData[index];
		this.client.addParam(kparams, 'flavorsData:' + index, kaltura.toParams(obj));
	}
	}
 ...
 * @param mediaInfo KalturaMediaInfo  (optional).
 * @return KalturaMediaInfo.
 */
KalturaBatchService.prototype.addMediaInfo = function(callback, mediaInfo){
	var kparams = {};
	this.client.addParam(kparams, 'mediaInfo', kaltura.toParams(mediaInfo));
 ...
 */
KalturaBatchService.prototype.getExclusiveNotificationJobs = function(callback, lockKey, maxExecutionTime, numberOfJobs, filter){
	if(!filter){
		filter = null;
	}
	var kparams = {};
 ...
 * @return .
 */
KalturaBatchService.prototype.updatePartnerLoadTable = function(callback){
	var kparams = {};
	this.client.queueServiceActionCall('batch', 'updatePartnerLoadTable', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
 ...
 * @return .
 */
KalturaBatchService.prototype.suspendJobs = function(callback){
	var kparams = {};
	this.client.queueServiceActionCall('batch', 'suspendJobs', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
 ...
 * @param id int The id of the job (optional).
 * @param lockKey KalturaExclusiveLockKey The unique lock key from the batch-process. Is used for the locking mechanism (optional).
 * @param jobType string The type of the job (optional, enum: KalturaBatchJobType).
 * @return .
 */
KalturaBatchService.prototype.resetJobExecutionAttempts = function(callback, id, lockKey, jobType){
	var kparams = {};
	this.client.addParam(kparams, 'id', id);
	this.client.addParam(kparams, 'lockKey', kaltura.toParams(lockKey));
 ...
 * @param lockKey KalturaExclusiveLockKey The unique lock key from the batch-process. Is used for the locking mechanism (optional).
 * @param jobType string The type of the job (optional, enum: KalturaBatchJobType).
 * @param resetExecutionAttempts bool Resets the job execution attampts to zero (optional, default: false).
 * @return KalturaFreeJobResponse.
 */
KalturaBatchService.prototype.freeExclusiveJob = function(callback, id, lockKey, jobType, resetExecutionAttempts){
 ...
 * @param workerQueueFilter KalturaWorkerQueueFilter The worker filter (optional).
 * @return int.
 */
KalturaBatchService.prototype.getQueueSize = function(callback, workerQueueFilter){
	var kparams = {};
	this.client.addParam(kparams, 'workerQueueFilter', kaltura.toParams(workerQueueFilter));
 ...
 * @param numberOfJobs int The maximum number of jobs to return (optional).
 * @param filter KalturaBatchJobFilter Set of rules to fetch only rartial list of jobs (optional, default: null).
 * @param jobType string The type of the job - could be a custom extended type (optional, enum: KalturaBatchJobType, default: null).
 * @param maxOffset int The maximum offset we accept for the distance from the best result (optional, default: null).
 * @return array.
 */
KalturaBatchService.prototype.getExclusiveJobs = function(callback, lockKey, maxExecutionTime, numberOfJobs, filter, jobType, maxOffset){
	if(!filter){
		filter = null;
	}
	if(!jobType){
 ...
 * @return array.
 */
KalturaBatchService.prototype.getExclusiveAlmostDone = function(callback, lockKey, maxExecutionTime, numberOfJobs, filter, jobType){
	if(!filter){
		filter = null;
	}
	if(!jobType){
 ...
 * @return KalturaBatchJob.
 */
KalturaBatchService.prototype.updateExclusiveJob = function(callback, id, lockKey, job){
	var kparams = {};
	this.client.addParam(kparams, 'id', id);
	this.client.addParam(kparams, 'lockKey', kaltura.toParams(lockKey));
	this.client.addParam(kparams, 'job', kaltura.toParams(job));
 ...
 * @return int.
 */
KalturaBatchService.prototype.cleanExclusiveJobs = function(callback){
	var kparams = {};
 ...
 * @return .
 */
KalturaBatchService.prototype.logConversion = function(callback, flavorAssetId, data){
	var kparams = {};
 ...
 * @param localPath string  (optional).
 * @param size float  (optional).
 * @return KalturaFileExistsResponse.
 */
KalturaBatchService.prototype.checkFileExists = function(callback, localPath, size){
	var kparams = {};
 ...
 * @param batchJobId string The entry to check (optional).
 * @return bool.
 */
KalturaBatchService.prototype.checkEntryIsDone = function(callback, batchJobId){
	var kparams = {};
	this.client.addParam(kparams, 'batchJobId', batchJobId);
	this.client.queueServiceActionCall('batch', 'checkEntryIsDone', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
...
/**
 *Class definition for the Kaltura service: DateAndTime.
 * The available service actions:
 * @action get Get Action.
 */
function KalturaDateAndTimeService(client){
	KalturaDateAndTimeService.super_.call(this);
	this.init(client);
}

util.inherits(KalturaDateAndTimeService, kaltura.KalturaServiceBase);
module.exports.KalturaDateAndTimeService = KalturaDateAndTimeService;
 ...
 * @return string.
 */
KalturaDateAndTimeService.prototype.get = function(callback, partnerId){
	var kparams = {};
	this.client.addParam(kparams, 'partnerId', partnerId);
	this.client.queueServiceActionCall('dateandtime', 'get', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
...
/**
 *Class definition for the Kaltura service: jobs.
 * The available service actions:
 * @action getImportStatus batch getImportStatusAction returns the status of import task.
 * @action deleteImport batch deleteImportAction deletes and returns the status of import task.
 * @action abortImport batch abortImportAction aborts and returns the status of import task.
 * @action retryImport batch retryImportAction retrys and returns the status of import task.
 * @action getProvisionProvideStatus // --------------------------------- ImportJob functions 	--------------------------------- //
 * 
 * 
 * 
 * 
 ...
 * @action deleteProvisionProvide batch deleteProvisionProvideAction deletes and returns the status of ProvisionProvide task.
 * @action abortProvisionProvide batch abortProvisionProvideAction aborts and returns the status of ProvisionProvide task.
 * @action retryProvisionProvide batch retryProvisionProvideAction retrys and returns the status of ProvisionProvide task.
 * @action getProvisionDeleteStatus // --------------------------------- ProvisionProvideJob functions 	--------------------------------- //
 * 
 * 
 * 
 ...
 * @action deleteProvisionDelete batch deleteProvisionDeleteAction deletes and returns the status of ProvisionDelete task.
 * @action abortProvisionDelete batch abortProvisionDeleteAction aborts and returns the status of ProvisionDelete task.
 * @action retryProvisionDelete batch retryProvisionDeleteAction retrys and returns the status of ProvisionDelete task.
 * @action getBulkUploadStatus // --------------------------------- ProvisionDeleteJob functions 	--------------------------------- //
 * 
 * 
 * 
 ...
 * @action deleteBulkUpload batch deleteBulkUploadAction deletes and returns the status of bulk upload task.
 * @action abortBulkUpload batch abortBulkUploadAction aborts and returns the status of bulk upload task.
 * @action retryBulkUpload batch retryBulkUploadAction retrys and returns the status of bulk upload task.
 * @action getConvertStatus batch getConvertStatusAction returns the status of convert task.
 * @action getConvertCollectionStatus batch getConvertCollectionStatusAction returns the status of convert task.
 * @action getConvertProfileStatus batch getConvertProfileStatusAction returns the status of convert task.
 * @action addConvertProfileJob batch addConvertProfileJobAction creates a new convert profile job.
 * @action deleteConvert batch deleteConvertAction deletes and returns the status of convert task.
 * @action abortConvert batch abortConvertAction aborts and returns the status of convert task.
 * @action retryConvert batch retryConvertAction retrys and returns the status of convert task.
 * @action deleteConvertCollection batch deleteConvertCollectionAction deletes and returns the status of convert profile task.
 * @action deleteConvertProfile batch deleteConvertProfileAction deletes and returns the status of convert profile task.
 * @action abortConvertCollection batch abortConvertCollectionAction aborts and returns the status of convert profile task.
 * @action abortConvertProfile batch abortConvertProfileAction aborts and returns the status of convert profile task.
 * @action retryConvertCollection batch retryConvertCollectionAction retrys and returns the status of convert profile task.
 * @action retryConvertProfile batch retryConvertProfileAction retrys and returns the status of convert profile task.
 * @action getPostConvertStatus batch getPostConvertStatusAction returns the status of post convert task.
 * @action deletePostConvert batch deletePostConvertAction deletes and returns the status of post convert task.
 * @action abortPostConvert batch abortPostConvertAction aborts and returns the status of post convert task.
 * @action retryPostConvert batch retryPostConvertAction retrys and returns the status of post convert task.
 * @action getCaptureThumbStatus batch getCaptureThumbStatusAction returns the status of capture thumbnail task.
 * @action deleteCaptureThumb batch deleteCaptureThumbAction deletes and returns the status of capture thumbnail task.
 * @action abortCaptureThumb batch abortCaptureThumbAction aborts and returns the status of capture thumbnail task.
 * @action retryCaptureThumb batch retryCaptureThumbAction retrys and returns the status of capture thumbnail task.
 * @action getExtractMediaStatus batch getExtractMediaStatusAction returns the status of extract media task.
 * @action deleteExtractMedia batch deleteExtractMediaAction deletes and returns the status of extract media task.
 * @action abortExtractMedia batch abortExtractMediaAction aborts and returns the status of extract media task.
 * @action retryExtractMedia batch retryExtractMediaAction retrys and returns the status of extract media task.
 * @action getStorageExportStatus batch getStorageExportStatusAction returns the status of export task.
 * @action deleteStorageExport batch deleteStorageExportAction deletes and returns the status of export task.
 * @action abortStorageExport batch abortStorageExportAction aborts and returns the status of export task.
 * @action retryStorageExport batch retryStorageExportAction retrys and returns the status of export task.
 * @action getStorageDeleteStatus batch getStorageDeleteStatusAction returns the status of export task.
 * @action deleteStorageDelete batch deleteStorageDeleteAction deletes and returns the status of export task.
 * @action abortStorageDelete batch abortStorageDeleteAction aborts and returns the status of export task.
 * @action retryStorageDelete batch retryStorageDeleteAction retrys and returns the status of export task.
 * @action getNotificationStatus batch getNotificationStatusAction returns the status of Notification task.
 * @action deleteNotification batch deleteNotificationAction deletes and returns the status of notification task.
 * @action abortNotification batch abortNotificationAction aborts and returns the status of notification task.
 * @action retryNotification batch retryNotificationAction retrys and returns the status of notification task.
 * @action getMailStatus batch getMailStatusAction returns the status of mail task.
 * @action deleteMail batch deleteMailAction deletes and returns the status of mail task.
 * @action abortMail batch abortMailAction aborts and returns the status of mail task.
 * @action retryMail batch retryMailAction retrys and returns the status of mail task.
 * @action addMailJob Adds new mail job.
 * @action addBatchJob batch addBatchJob action allows to add a generic BatchJob.
 * @action getStatus batch getStatusAction returns the status of task.
 * @action deleteJob batch deleteJobAction deletes and returns the status of task.
 * @action abortJob batch abortJobAction aborts and returns the status of task.
 * @action retryJob batch retryJobAction aborts and returns the status of task.
 * @action boostEntryJobs batch boostEntryJobsAction boosts all the jobs associated with the entry.
 * @action listBatchJobs list Batch Jobs.
 */
function KalturaJobsService(client){
	KalturaJobsService.super_.call(this);
	this.init(client);
}

util.inherits(KalturaJobsService, kaltura.KalturaServiceBase);
module.exports.KalturaJobsService = KalturaJobsService;

/**
 * batch getImportStatusAction returns the status of import task.
 * @param jobId int the id of the import job (optional).
 ...
 * @param jobId int the id of the bulk upload job (optional).
 * @return KalturaBatchJobResponse.
 */
 ...
 * 
 * /batch getProvisionProvideStatusAction returns the status of ProvisionProvide task.
 * @param jobId int the id of the ProvisionProvide job (optional).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getProvisionProvideStatus = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.deleteProvisionProvide = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.abortProvisionProvide = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryProvisionProvide = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * 
 * /batch getProvisionDeleteStatusAction returns the status of ProvisionDelete task.
 * @param jobId int the id of the ProvisionDelete job (optional).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getProvisionDeleteStatus = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.deleteProvisionDelete = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.abortProvisionDelete = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryProvisionDelete = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @param jobId int the id of the convert job (optional).
 * @return KalturaBatchJobResponse.
 */
 ...
 * @param jobId int the id of the convert profile job (optional).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getConvertCollectionStatus = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @param entryId string the id of the entry to be reconverted (optional).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.addConvertProfileJob = function(callback, entryId){
	var kparams = {};
	this.client.addParam(kparams, 'entryId', entryId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.deleteConvertCollection = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.abortConvertCollection = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryConvertCollection = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @param jobId int the id of the post convert job (optional).
 * @return KalturaBatchJobResponse.
 */
 ...
 * @param jobId int the id of the capture thumbnail job (optional).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getCaptureThumbStatus = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.deleteCaptureThumb = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.abortCaptureThumb = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryCaptureThumb = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @param jobId int the id of the extract media job (optional).
 * @return KalturaBatchJobResponse.
 */
 ...
 * @param jobId int the id of the export job (optional).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getStorageExportStatus = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.deleteStorageExport = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.abortStorageExport = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryStorageExport = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getStorageDeleteStatus = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.deleteStorageDelete = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.abortStorageDelete = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryStorageDelete = function(callback, jobId){
	var kparams = {};
	this.client.addParam(kparams, 'jobId', jobId);
 ...
 * @param jobId int the id of the Notification job (optional).
 * @return KalturaBatchJobResponse.
 */
 ...
 * @param jobId int the id of the mail job (optional).
 * @return KalturaBatchJobResponse.
 */
...
/**
 * Adds new mail job.
 * @param mailJobData KalturaMailJobData  (optional).
 * @return .
 */
KalturaJobsService.prototype.addMailJob = function(callback, mailJobData){
	var kparams = {};
	this.client.addParam(kparams, 'mailJobData', kaltura.toParams(mailJobData));
 ...
 * @param batchJob KalturaBatchJob  (optional).
 * @return KalturaBatchJob.
 */
KalturaJobsService.prototype.addBatchJob = function(callback, batchJob){
	var kparams = {};
	this.client.addParam(kparams, 'batchJob', kaltura.toParams(batchJob));
 ...
 * @param jobId int the id of the job (optional).
 * @param jobType string the type of the job (optional, enum: KalturaBatchJobType).
 * @param pager KalturaFilterPager pager for the child jobs (optional, default: null).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.getStatus = function(callback, jobId, jobType, pager){
	if(!pager){
		pager = null;
	}
	var kparams = {};
 ...
 * @param jobId int the id of the job (optional).
 * @param jobType string the type of the job (optional, enum: KalturaBatchJobType).
 * @param force bool should we force the restart (optional, default: false).
 * @return KalturaBatchJobResponse.
 */
KalturaJobsService.prototype.retryJob = function(callback, jobId, jobType, force){
	if(!force){
		force = false;
	}
	var kparams = {};
 ...
 * @param entryId string the id of the entry to be boosted (optional).
 * @return .
 */
KalturaJobsService.prototype.boostEntryJobs = function(callback, entryId){
	var kparams = {};
	this.client.addParam(kparams, 'entryId', entryId);
	this.client.queueServiceActionCall('jobs', 'boostEntryJobs', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
/**
 * list Batch Jobs.
 * @param filter KalturaBatchJobFilter  (optional, default: null).
 * @param pager KalturaFilterPager  (optional, default: null).
...
/**
 *Class definition for the Kaltura service: LastEntry.
 * The available service actions:
 * @action get Get Action.
 */
function KalturaLastEntryService(client){
	KalturaLastEntryService.super_.call(this);
	this.init(client);
}

util.inherits(KalturaLastEntryService, kaltura.KalturaServiceBase);
module.exports.KalturaLastEntryService = KalturaLastEntryService;
 ...
 * @return string.
 */
KalturaLastEntryService.prototype.get = function(callback, partnerId){
	var kparams = {};
	this.client.addParam(kparams, 'partnerId', partnerId);
	this.client.queueServiceActionCall('lastentry', 'get', kparams);
	if (!this.client.isMultiRequest()){
		this.client.doQueue(callback);
	}
};
 ...
 * @param cuePointId
 */
KalturaFlavorAssetService.prototype.serveAdStitchCmd = function(callback, assetId, ffprobeJson, duration, cuePointId){
	if(!ffprobeJson){
		ffprobeJson = null;
	}
	if(!duration){
	...
	this.client.addParam(kparams, 'duration', duration);
	this.client.addParam(kparams, 'cuePointId', cuePointId);
