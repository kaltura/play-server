...
function KalturaClient(config) {
	...
	this.setClientTag('node:16-06-20');
	this.init(config);
}
 ...
 * @param kaltura.services.KalturaAnalyticsService
 */
 ...
 * ServerID
 * ParternGroups
 * @param kaltura.services.KalturaBatchcontrolService
 */
 ...
 * ServerID
 * ParternGroups
 * @param kaltura.services.KalturaBatchService
 */
KalturaClient.prototype.batch = null;
/**
...
/**
 * this is a new service as task for new employee
 * 25.4.16
 * @param kaltura.services.KalturaDateAndTimeService
 */
KalturaClient.prototype.DateAndTime = null;
/**
 ...
 * ServerID
 * ParternGroups
 * @param kaltura.services.KalturaJobsService
 */
KalturaClient.prototype.jobs = null;
/**
 * this is a new service as task for new employee
 * 25.4.16
 * @param kaltura.services.KalturaLastEntryService
 */
KalturaClient.prototype.LastEntry = null;
/**
...
KalturaClient.prototype.init = function(config){
	...
	this.analytics = new kaltura.services.KalturaAnalyticsService(this);
	...
	this.batchcontrol = new kaltura.services.KalturaBatchcontrolService(this);
	this.batch = new kaltura.services.KalturaBatchService(this);
	...
	this.DateAndTime = new kaltura.services.KalturaDateAndTimeService(this);
	...
	this.jobs = new kaltura.services.KalturaJobsService(this);
	this.LastEntry = new kaltura.services.KalturaLastEntryService(this);
