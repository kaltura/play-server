...
class FetchIdentifier
{
    ...
    static getFetchId(encodedFetchUrl,callback)
    {
        KalturaTinyUrl.load(encodedFetchUrl,function(decodedFetchUrl)
            {
                const fetchIdentifier = new FetchIdentifier(decodedFetchUrl.cuePointId, decodedFetchUrl.cuePointUrl, decodedFetchUrl.flavorIdList, decodedFetchUrl.cuePointDuration, decodedFetchUrl.fillerId);
