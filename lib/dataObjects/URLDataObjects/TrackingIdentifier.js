...
class TrackingIdentifier
{
    ...
    static getTrackingId(encodedTrackingUrl,callback)
    {
        KalturaTinyUrl.load(encodedTrackingUrl,function(decodedTrackingUrl)
            {
                const trackingIdentifier = new TrackingIdentifier(decodedTrackingUrl.type, decodedTrackingUrl.url, decodedTrackingUrl.cuePointId, decodedTrackingUrl.flavorId, decodedTrackingUrl.seqId);
