...
class AdBreakIdentifier
{
    ...
    static getAdBreakId(encodedAdBreakUrl,callback)
    {
        KalturaTinyUrl.load(encodedAdBreakUrl,function(decodedAdBreakUrl)
            {
                const adBreakIdentifier = new AdBreakIdentifier(decodedAdBreakUrl.cuePointId, decodedAdBreakUrl.flavorId, decodedAdBreakUrl.duration, decodedAdBreakUrl.fetchId);
