...
class VodData
{
	...
	constructor(partnerId, flavorDataList, selectedFlavorIds, entry, uiConf, cuePointList, blackFillerTranscodeCommands)
	{
		this.entry = entry;
		...
		this.blackFillerTranscodeCommandList = blackFillerTranscodeCommands;
	}
	...
	getSelectedFlavorPaths()
	{
		...
		{
			if (this.selectedFlavorIdList.indexOf(this.flavorDataList[j].id) !== -1)
