...
class VODManifestLayoutData
{
	...
	toJSON()
	{
		...
		if (this.notifications.length === 0)
			return `{${idString}, ${discontinuityString}, ${durationsString}, ${sequencesString}}`;
		else
			return `{${idString}, ${discontinuityString}, ${durationsString}, ${sequencesString}, ${notificationsString}}`;
	}
}
