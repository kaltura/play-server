...
class ApiServerClientConnector
{
	 ...
	 */
	handleRequset(apiCallService, apiCallAction, params = null, impersonatePartnerId = null)
	{
		const This = this;
		...
		if (!This.client.getKs())
		{
			...
			then(This._handleRequsetPromise);
		}
		return This._handleRequsetPromise({ requestParams: reqParams });
	}
