...
KalturaSegmentManager.prototype.exec = function(segmentId, cutOffset, portion, inputFiles){
	...
	var This = this;
	tsCutter.cutTsFiles(outputFile, ffmpegBin, ffprobeBin, cutOffset, leftPortion, inputFiles, function(){
		This.save(segmentId, outputFile, KalturaAdManager.MAX_DVR_LENGTH);
	});
};
