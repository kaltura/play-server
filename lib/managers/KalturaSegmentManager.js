 ...
 * @param segmentPath
 */
KalturaSegmentManager.prototype.save = function(segmentKey, segmentPath, expiry){
...
KalturaSegmentManager.prototype.exec = function(segmentId, cutOffset, portion, inputFiles){
	...
	kaltura.tsCutter.cutTsFiles(outputFile, ffmpegBin, ffprobeBin, cutOffset, leftPortion, inputFiles, function(){
		This.save(KalturaCache.getSegmentMedia(segmentId), outputFile, KalturaSegmentManager.MAX_DVR_LENGTH);
	});
};
