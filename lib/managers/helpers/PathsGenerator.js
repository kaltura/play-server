class PathsGenerator {
	...
	static generateApiServerFlavorURL(partnerId, flavorId, pathOnly)
	{
		const url = `${KalturaConfig.config.client.serviceUrl}/p/${partnerId}/serveFlavor/flavorId/${flavorId}`;
		if (pathOnly)
