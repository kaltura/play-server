...
class TranscodingHelper {
	...
	static getAdaptedTranscodingCommand(flavorId, jsonInfo, durationInSeconds, apiConnector, partnerId, inPath, outFilePrefixPath)
	{
		return new Promise( function(resolve,reject){
			function successfullyGeneratedCommand(data)
			{
				KalturaLogger.log(`Generated command line for transcoding is ${data}`);
				const outPath = PathsGenerator.generateSpecificTranscodedPath(outFilePrefixPath, data);
