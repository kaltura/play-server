...
/* global KalturaConfig KalturaLogger KalturaUtils KalturaCache AD FLAVORS_SIGN_SEPARATOR*/
				...
				function (promiseResults)
				{
					...
					for (let i = 0; i < flavorAssetList.length; i++)
					{
						if (KalturaConfig.config.h264Verification.enabled === 'true')
							H264Verifier.insertFlavorPathToCache(flavorAssetList[i].id, promiseResults[i]);
