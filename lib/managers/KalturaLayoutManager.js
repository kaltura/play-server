				...
				This.client.doMultiRequest(
					function (results)
					{
						...
						if (This.areValidApiResults(results, callers))
						{
							...
							const cuePointsListResponse = results[1];
							const flavorUrls = results.slice(2);
							const vodData = new VodData(partnerId, flavorIds, entryResponse, cuePointsListResponse, flavorUrls);
