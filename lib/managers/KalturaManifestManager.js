 ...
 */
KalturaManifestManager.prototype.stitchCuePoints = function(request, response, partnerId, entryId, uiConfId, sessionId){
	var This = this;
	var encodingIds = [];
	var mediaInfos = null;
	var entry = null;
	...
	KalturaCache.getMulti([cuePointsKey, elapsedTimeKey, entryRequiredKey, playerConfigKey, uiConfConfigKey], function(data){
		...
		if(!data[uiConfConfigKey]){
			This.getAndStoreUiConfConfig(uiConfId, entryId, partnerId, function(uiConfConfigRes) {
 ...
 * @param entryId
 */
KalturaManifestManager.prototype.getRenditionFromCache = function(request, response, partnerId, entryId, uiConfId, renditionId, masterUrl, sessionId, trackCuePoints){
	var This = this;
	...
	var handleManifestContent = function(){
		...
		KalturaCache.get(manifestContentKey, function(manifestContent) {
			if(manifestContent){
				...
				if(trackCuePoints){
					This.stitchCuePoints(request, response, partnerId, entryId, uiConfId, sessionId);
				}
			}
			else{
				...
				setTimeout(function(){
					...
					This.getRenditionFromCache(request, response, partnerId, entryId, uiConfId, renditionId, masterUrl, sessionId, trackCuePoints);
...
KalturaManifestManager.prototype.rendition = function(request, response, params){
	...
	this.getRenditionFromCache(request, response, params.partnerId, params.entryId, params.uiConfId, params.renditionId, masterUrl, params.sessionId, params.trackCuePoints);
