...
KalturaManifestManager.prototype.startStreamWatchers = function(partnerId, entryId, manifestUrl, renditionsWatchParams) {
	...
	var masterManifestRequiredKey = KalturaCache.getMasterManifestRequired(manifestUrl);
	KalturaCache.set(masterManifestRequiredKey, true, KalturaConfig.config.cache.entryRequired);
...
KalturaManifestManager.prototype.rendition = function(request, response, params){
	...
	KalturaCache.touch(entryRequiredKey, KalturaConfig.config.cache.entryRequired);
	var masterManifestRequiredKey = KalturaCache.getMasterManifestRequired(masterUrl);
	KalturaCache.touch(masterManifestRequiredKey, KalturaConfig.config.cache.entryRequired);
};
