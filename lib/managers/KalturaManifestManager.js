 ...
 * @returns string
 */
KalturaManifestManager.prototype.stitchMasterM3U8 = function(partnerId, entryId, uiConfConfigId, manifestUrl, trackCuePoints, manifestContent) {
 ...
 * @param entryId
 */
KalturaManifestManager.prototype.getRenditionFromCache = function(request, response, partnerId, entryId, uiConfConfigId, renditionId, masterUrl, sessionId, playerConfig, sessionStartTime, originDc){
	var This = this;
		...
		KalturaCache.get(manifestContentKey, function(manifestContent) {
			if(manifestContent){
				...
				if(response.retries == 1){
					...
					This.fetchMaster(response, masterUrl, entryId, true, uiConfConfigId, function(data, fromCache){
						...
						if(fromCache){
							...
							body = This.stitchMasterM3U8(partnerId, entryId, uiConfConfigId, masterUrl, true, body);
						}
					}, function(err){
						response.error(err);
					});
				...
				setTimeout(function(){
					...
					This.getRenditionFromCache(request, response, partnerId, entryId, uiConfConfigId, renditionId, masterUrl, sessionId, playerConfig, sessionStartTime);
...
KalturaManifestManager.prototype.rendition = function(request, response, params){
	...
	this.getRenditionFromCache(request, response, params.partnerId, params.entryId, params.uiConfConfigId, params.renditionId, masterUrl, params.sessionId, params.playerConfig, params.sessionStartTime, params.originDc);
