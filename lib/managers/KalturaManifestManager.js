...
KalturaManifestManager.prototype.stitchCuePoints = function(request, response, entryId, callback){
	...
	var stitchAd = function(cuePoint) {
		...
		KalturaAdIntegrationHandler.getAdMediaFiles(cuePoint, playerConfig, headers, mediaInfos, function(adId, adInfo){
			...
			KalturaCache.set(adId, adInfo, KalturaConfig.config.cache.encodingParams);
