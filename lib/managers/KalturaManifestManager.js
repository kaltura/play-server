 ...
 */
KalturaManifestManager.prototype.stitchCuePoints = function(request, response, partnerId, entryId, uiConfConfig, sessionId, callback){
	var This = this;
	var encodingIds = [];
	var mediaInfos = null;
	var entry = null;
	...
	var handleManifestContent = function(){
		...
		KalturaCache.get(manifestContentKey, function(manifestContent) {
			if(manifestContent){
				...
				if(trackCuePoints){
					This.stitchCuePoints(request, response, partnerId, entryId, uiConfConfig, sessionId, function(){
