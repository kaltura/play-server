...
KalturaManifestManager.prototype.startStreamWatcher = function(partnerId, entryId, manifestUrl, renditionWatchParams) {
	...
	var renditionRequiredKey = KalturaCache.getRenditionRequired(KalturaCache.getManifestId(renditionWatchParams.url));
	KalturaCache.set(renditionRequiredKey, true, KalturaConfig.config.cache.entryRequired);
...
KalturaManifestManager.prototype.rendition = function(request, response, params){
	...
	KalturaCache.touch(entryRequiredKey, KalturaConfig.config.cache.entryRequired);
	var renditionRequiredKey = KalturaCache.getRenditionRequired(params.renditionId);
	KalturaCache.touch(renditionRequiredKey, KalturaConfig.config.cache.entryRequired);
};
