 ...
 * @returns
 */
KalturaAdIntegrationManager.prototype.getAdMediaFiles = function(request, cuePoint, cachedUrl, entry, metadata, playerConfig, mediaInfos, sessionId, uiConfConfig, downloadCallback, finalCallback, errorCallback) {
	var This = this;	
	...
	KalturaLogger.log('Parsing ads from [' + cuePoint.sourceUrl + '] cue point [' + cuePoint.id + '] session [' + sessionId + ']');
