 ...
 * @service testing
 */
class KalturaMockManager extends kaltura.KalturaManager {
    constructor() {
        super();
    }
    ...
    getVast(request, response, params) {
        let This = this;
        let fileName = KalturaConfig.config.tests.resourcesPath + '/vast' + KalturaTestingManager.getRandomNumber(1, 10) + '.xml';
