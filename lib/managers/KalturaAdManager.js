			...
			ffmpegProcessesCmd.exec(function(numberOfProccesses){
				...
				if(numberOfFfmpeg > maxFfmpegProcesses) {
					...
					var sleepHighWatermark = 20;
				    	...
				    	KalturaLogger.error('Number of ffmpeg processes [' + numberOfFfmpeg + '] exceeded high watermark [' + numFfmpegHighWatermark + '], file [' + adPath + ']. Retring in [' + sleepHighWatermark + '] seconds.');
					...
					KalturaLogger.error('Number of ffmpeg processes [' + numberOfFfmpeg + '] exceeded low watermark [' + numFfmpegLowWatermark + '], file [' + adPath + ']. Retring in [' + sleepLowWatermark + '] seconds.');
