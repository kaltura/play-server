...
KalturaStreamWatcher.prototype = {
	...
	initSegmentsHistory: function(manifest, startSegment){
		...
		var firstSegmentsHistorySequence = parseInt(Object.keys(this.segmentsHistory)[0]);
		var lastSegmentsHistorySequence = firstSegmentsHistorySequence + Object.keys(this.segmentsHistory).length - 1;		
		this.parseSegmentWhenRequired(lastSegmentsHistorySequence, firstSegmentsHistorySequence, lastSegmentsHistorySequence);
