...
var KalturaStreamWatcher = function(manager, params, finishCallback){
	...
	this.renditionRequiredKey = KalturaCache.getRenditionRequired(this.renditionId);
...
KalturaStreamWatcher.prototype = {
	...
	verifyTrackingRequired: function(){
		var This = this;
		KalturaCache.getMulti([this.entryRequiredKey, this.renditionRequiredKey], function(data){
			if(data[This.renditionRequiredKey]){
