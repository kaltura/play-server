...
var KalturaStreamWatcher = function(manager, params, finishCallback){
	...
	this.trackerOutputKeyWithAds = KalturaCache.getManifestContent(this.renditionId) + '_' + KalturaStreamWatcher.MANIFEST_ADS_EXTENSION;
	this.trackerOutputKeyWithoutAds = KalturaCache.getManifestContent(this.renditionId) + '_' + KalturaStreamWatcher.MANIFEST_NO_ADS_EXTENSION;
...
KalturaStreamWatcher.MANIFEST_ADS_EXTENSION = 1;
KalturaStreamWatcher.MANIFEST_NO_ADS_EXTENSION = 0;
