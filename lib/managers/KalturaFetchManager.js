	...
	_createFillerForFlavor(flavorId, sessionId, partnerId, cuePointId, fillerId)
	{
		...
		function createFiller(adsReadyCacheKey, resolveCallback, rejectCallback)
		{
			function successfullyTranscodedFiller(transcodedFileInfo)
			{
				...
				This._updateCacheWithTranscodedFillerData(adsReadyCacheKey, Math.floor(transcodedFileInfo.durationInSeconds * 1000), transcodedFileInfo.filePath);
									...
									function (filePath)
									{
										...
										This._transcodeAdAndSaveToDisk(filePath, flavorId, partnerId,
											function (outPath, adDurationInseconds)
											{
												...
												This._updateCacheWithTranscodedAdData(adsReadyCacheKey, Math.floor(adDurationInseconds * 1000), outPath, trackingList);
												resolve();
											}
										);
									},
