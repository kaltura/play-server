...
class KalturaFetchManager extends kaltura.KalturaManager
{
	...
	{
		if (typeof AdBreakKeyHelper.getErrorCacheValue !== 'function')
			KalturaLogger.error('Could not find the AdBreakKeyHelper.getErrorCacheValue function');
		const value = AdBreakKeyHelper.getErrorCacheValue(error);
