...
describe('testApiClientConnector', function () {
	...
	it('test session start', function (done) {
	...
	it('test api exception', function (done) {
	...
	it('test handleApiRequest with uiConf get action ', function (done) {
	...
	it('test setValueInCache  ', function (done) {
	...
	it('test getValueFromCache  ', function (done) {
		const params = { apiCallService: 'someService', apiCallAction: 'someAction', params: [199], impersonatePartnerId: 101};
	...
	it('test handleApiRequest with flavorId get action', function (done) {
