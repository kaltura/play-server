...
const kaltura = require('./../../lib/managers/KalturaLayoutManager');
...
const kalturaLayoutManager = new kaltura.KalturaLayoutManager();
...
describe('testManifestLayout middle cue points and no cuepoints ', function() {
	...
	const vodData = new VodData(PARTNER_ID, FLAVOR_IDS, matchingEntry, middleCuePoints, flavorUrls);
...
describe('testManifestLayout ending cue points', function() {
	...
	const vodData = new VodData(PARTNER_ID, FLAVOR_IDS, matchingEntry, endingCuePoints, flavorUrls);
...
describe('test matching of flavors and entry', function() {
	it('test expected success match ', function(){
		const vodData = new VodData(PARTNER_ID, FLAVOR_IDS, matchingEntry, middleCuePoints, flavorUrls);
		const isMatch = kaltura.KalturaLayoutManager._isEntryFlavorsMatch(vodData);
		expect(isMatch).to.equal(true);
	});
	it('test expected failure match ', function(){
		const vodData = new VodData(PARTNER_ID, FLAVOR_IDS, nonMatchingEntry, middleCuePoints, flavorUrls);
		const isMatch = kaltura.KalturaLayoutManager._isEntryFlavorsMatch(vodData);
